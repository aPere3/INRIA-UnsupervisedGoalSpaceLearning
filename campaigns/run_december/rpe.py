...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(prog="Random Parameterization Exploration",
                                     usage="Input the environment to use",
                                     description="This script performs experiments on random parameterization exploration")
